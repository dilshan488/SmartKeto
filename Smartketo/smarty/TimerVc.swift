...
class TimerVc: UIViewController {
    ...
    private func setupUI(){
       ...
       // self.startButton.configuration?.baseBackgroundColor = UIColor.AppColor
        self.startButton.backgroundColor = UIColor.systemMint
        ...
        self.resetButton.backgroundColor = UIColor.systemMint
        ...
        self.pauseButton.backgroundColor = UIColor.systemMint
